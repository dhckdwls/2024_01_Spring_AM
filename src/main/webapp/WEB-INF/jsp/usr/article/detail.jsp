				...
				<c:forEach var="reply" items="${replies }">
					<tr class="hover">
						...
						<td><c:if test="${reply.userCanModify }">
								...
								<button onclick="off(${reply.id});" style="white-space: nowrap; display: none;"
									id="esc-btn-${reply.id }" class="btn btn-outline">취소</button>
							</c:if></td>
